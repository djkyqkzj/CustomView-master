...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MainActivity.this,DragSortLIstViewNewActivity.class);
//                Intent intent=new Intent(MainActivity.this,DragSortListViewActivity.class);
                startActivity(intent);
            }
        });

        textView8=findViewById(R.id.activity_main_gridview);
        textView8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MainActivity.this,DragSortGridViewActivity.class);
                startActivity(intent);
            }
        });
